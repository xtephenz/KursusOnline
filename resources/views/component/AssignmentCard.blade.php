            ...
            <div class="card" style="width: 20rem;">
                <div class="card-body d-flex flex-column gap-1">
                    @if ($assignments[$i]->status == "On Going")
                        <h1 class="btn" style="width: 100px; background-color: rgb(61, 155, 93); color:white; font-weight: 500; border-radius: 20px;">{{$assignments[$i]->status}}</h1>
                    ...
                    @elseif ($assignments[$i]->status == "Coming Soon")
                        <h1 class="btn" style="width: 130px; background-color: rgb(220, 170, 32); color:white; font-weight: 500; border-radius: 20px;">{{$assignments[$i]->status}}</h1>
                    @endif
